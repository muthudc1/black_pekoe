...
import com.dreamzcoder.blackpekoe.adapter.SectionAdapter.SectionHolder
import com.dreamzcoder.blackpekoe.fragment.ProductListFragment
import com.dreamzcoder.blackpekoe.helper.Constant
import com.dreamzcoder.blackpekoe.model.OfferImages
...
class SectionAdapter(
    ...
    override fun onBindViewHolder(holder: SectionHolder, position: Int) {
        try {
            ...
            if (section.products.size > 0) {
                ...
                holder.tvTitle1.text = section.title
    ...
    class SectionHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val tvTitle1: TextView = itemView.findViewById(R.id.tvTitle1)

...
import com.dreamzcoder.blackpekoe.fragment.CartFragment
    ...
    private fun removeItem(position: Int) {
        if (isLogin) {
            ...
            for ((index, cart1) in Constant.countList.withIndex()) {
                if (cart1.product_id == cart.product_id && cart1.product_variant_id == cart.product_variant_id) Constant.countList[index].qty = "0"
            }
            CartFragment.setData(activity)
